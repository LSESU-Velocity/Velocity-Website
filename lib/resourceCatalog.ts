...
export const resourceCatalog: ResourceDefinition[] = [
  ...
  },
  {
    ...
    description:
      'Verified perks on Cursor, Perplexity, GitHub, Notion, and the rest of the modern builder stack.',
  ...
  },
  {
    ...
    eyebrow: 'Explore',
    tagline: 'Curated AI tools and how we use them',
    description:
      'The vibe coding stack with quick verdicts, pricing notes, and real use cases.',
    navDescription: 'Curated AI tools with our verdicts on each.',
